...
/**
 * This is a test program for the Calculator (testing a Calculator object) It
 * should output true for everything
 *
 * Right click and run ...
 */
class Test {
    ...
    void test() {
        ...
        /*
         * List<String> l = new ArrayList<>(); out.println( calculator.readNumber(l,
         * "10+ 45 - 3", 0) == 2); out.println( calculator.readNumber(l, "10+ 45 - 3",
         * 4) == 6); out.println( calculator.readNumber(l, "10+ 45 - 3", 9) == 10);
         * out.println(l.toString().equals("[10, 45, 3]"));
         */
        /*
         * out.println(calculator.topHasHigherPrecedence("+", "*"));
         * out.println(!calculator.topHasHigherPrecedence("^", "-"));
         */
        /*
         * Deque<String> stack = new ArrayDeque<>(); stack.push("*"); stack.push("/");
         * List<String> ops = calculator.getHigherPrecedenceOps("+", stack);
         * out.println( ops.toString().equals("[/, *]"));
         * 
         * stack.push("+"); stack.push("-"); ops =
         * calculator.getHigherPrecedenceOps("*", stack); out.println(
         * ops.toString().equals("[]"));
         */

        /*
         * Deque<String> stack = new ArrayDeque<>(); stack.push("*"); stack.push("/");
         * stack.push("("); stack.push("+"); stack.push("-"); // Leading parentheses
         * skipped List<String> ops = calculator.getParenthesesOps(stack);
         * out.println(ops.toString().equals("[+, -]"));
         */
